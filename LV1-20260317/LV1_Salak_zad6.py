...
def main():
    try:
        with open("SMSSpamCollection.txt", "r", encoding="utf-8") as file:
            ...
            print(f"(a) Prosjecan broj rijeci u ham porukama: {prosjek_ham:.2f}")
            print(f"(a) Prosjecan broj rijeci u spam porukama: {prosjek_spam:.2f}")
            print(f"(b) Broj spam poruka koje zavrsavaju usklicnikom: {spam_zavrsava_usklicnik}")
